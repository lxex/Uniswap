    ...
    <HeaderFrame>
      ...
      <HeaderRow>
        ...
        <HeaderLinks>
          ...
          <StyledExternalLink id={`stake-nav-link`} href={'https://swap.eros.fund/cross/#/'}>
            Crosschain <span style={{ fontSize: '11px' }}>↗</span>
          </StyledExternalLink>
            ...
            <UNIWrapper onClick={toggleClaimModal}>
              <UNIAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto' }}>
                <TYPE.white padding="0 2px">
                  {claimTxn && !claimTxn?.receipt ? <Dots>Claiming EROS</Dots> : 'Claim EROS'}
                </TYPE.white>
              </UNIAmount>
              <CardNoise />
            </UNIWrapper>
